...
from resources.user import Users, UsersList, UsersPostsList, UsersCommentsList
...
api.add_resource(UsersPostsList, '/user/<string:user_id>/posts',
                 '/user/<string:user_id>/posts/',
                 endpoint='user_posts')
api.add_resource(UsersCommentsList, '/user/<string:user_id>/comments',
